...
class NMT(nn.Module):
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in torch.split(Y, 1, dim=0):
            ...
            (new_hidden, new_cell), o_t, _ = self.step(Ybar_t, dec_state, enc_hiddens, enc_hiddens_proj, enc_masks)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        # e_t = torch.bmm(dec_hidden.unsqueeze(1), enc_hiddens_proj.permute(0, 2, 1)).squeeze(dim=1)
